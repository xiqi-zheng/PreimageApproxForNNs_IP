...
#########################################################################
"""
Set up arguments for preimage analysis.
"""
...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        self.add_argument("--loss_reduction_func", default="max",
        ...
        self.add_argument('--no_incomplete', action='store_true', dest='incomplete',
        ...
        self.add_argument("--csv_name", type=str, default=None,
                          ...
                          hierarchy=h + ["csv_name"]) # "instances.csv"
        ...
        self.add_argument('--init_iteration', type=int, default=20,
        ...
        h = ["bab"]
        self.add_argument("--initial_max_domains", type=int, default=100,
        ...
        self.add_argument("--disable_batched_domain_list", action='store_true', dest='batched_domain_list',
